...
proc create_root_design { parentCell } {
  ...
  set PL_RSTN [ create_bd_port -dir O -type rst PL_RSTN ]

  # Create instance: zynq, and set properties
  set zynq [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.3 zynq ]
  ...
  connect_bd_net -net zynq_pl_resetn0 [get_bd_ports PL_RSTN] [get_bd_pins zynq/pl_resetn0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports PL_CLK] [get_bd_pins zynq/maxihpm0_fpd_aclk] [get_bd_pins zynq/pl_clk0]
